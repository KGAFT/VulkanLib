...
std::shared_ptr<DescriptorPool> DescriptorPool::getInstance(std::shared_ptr<LogicalDevice> device) {
    if(!initialized){
...
DescriptorPool::DescriptorPool(std::shared_ptr<LogicalDevice> logicalDevice) : logicalDevice(logicalDevice) {
